...
<head>
    ...
    <title>Casa Felice Management</title>
    ...
    <link href="{{ asset('vendor/sbadmin2/css/sb-admin-2.css') }}" rel="stylesheet">
        ...
        <ul class="navbar-nav bg-gold sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img src="{{ asset('img/logoNoBg.png') }}" alt="" height="40px">
                </div>
                <div class="sidebar-brand-text mx-3">Casa Felice Management</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="occupancyList">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Occupied</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="bookkeeping">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
            ...
            <li class="nav-item">
                <a class="nav-link" href="inventoryActionList">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset('vendor/sbadmin2/img/undraw_profile.svg') }}">
                            </a>
